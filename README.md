...
- Add your Spotify client ID, secret, and redirect URL to a `.env` file in root using the environment variables `REACT_APP_SPOTIFY_CLIENT_ID` , `REACT_APP_SPOTIFY_CLIENT_SECRET` and `REACT_APP_SPOTIFY_REDIRECT_URL`
